                                ...
                                <form action="{{route('aviso.editar.save')}}" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label>Atiende</label>
                                                <input class="form-control" name="atiende" required value="{{$aviso->persona_contacto}}">
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="email" class="form-control" name="correo_electronico" value="{{$aviso->correo_electronico}}">
                                            </div>
